...
<div class="w3-main" style="margin-left:300px">
  ...
  <span class="w3-button w3-hide-large w3-xxlarge w3-hover-text-grey" onclick="w3_open()"><i class="fa fa-bars"></i></span>
	...
	<div style="padding-top: 50px; padding-left: 50px; padding-right: 50px; padding-bottom: 50px;">
	  <h1 class="ui dividing header" style="font-weight: 100;">월별 작업 목록 </h1>
				...
				<c:choose>
  				<c:when test="${fn:length(list) > 0}">
  					<c:forEach items="${list}" var="row">
  						...
  						<br>
  						<a href="product_detail_jego_v2.do?offer_no=${row.OFFER_NO}&work_gb=${row.WORK_GB}&insert_gb=V&magam_gb=${row.MAGAM_GB}" class="item"> 
  						...
  						<br>
  						<a href="product_detail_ipgo_v2.do?offer_no=${row.OFFER_NO}&work_gb=${row.WORK_GB}&insert_gb=V&magam_gb=${row.MAGAM_GB}" class="item"> 
